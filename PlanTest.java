...
import com.afrin.TravelWebAppApplication;
import com.afrin.entity.Plan;
import com.afrin.service.PlanService;
...
public class PlanTest {
	...
	public void setUp() throws Exception{
		plan = new Plan();
		java.sql.Date date = java.sql.Date.valueOf( "2021-03-30" );
		plan.setUserId(1);
		plan.setPlaceId(1);
		plan.setPlace("test");
	...
	public void testGetDateTravel() {
		assertEquals("2021-03-30", plan.getDateTravel().toString());
	}
	
	@Test
	public void testGetDateAdded() {
		assertEquals("2021-03-30", plan.getDateAdded().toString());
	}
